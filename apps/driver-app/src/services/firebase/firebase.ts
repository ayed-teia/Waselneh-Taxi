/**
 * Firebase Native SDK Configuration for Driver App
 * Native side auto-initializes from google-services.json
 * JS side just retrieves the already-initialized app
 */
...
// ============================================================================
// FIREBASE APP - Already initialized by Native SDK via google-services.json
// ============================================================================
...
export const firebaseDB = firestore(firebaseApp);
export const firebaseFunctions = functions(firebaseApp);

// Log initialization status
console.log('✅ Firebase Native initialized:', firebaseApp.name);
