 ...
 * the UI is reachable at all; the dev custom-token sign-in (and its auto-login) is
 * untouched and remains the path when the flag is off. Merging this changes nothing until a human enables it
